---
layout: page
title: Nos Produits Acier
link: Nos produits
order: 2
---

## Toutes les Solutions Acier pour Vos Projets

Que vous soyez artisan, entreprise du bâtiment, charpentier métallique ou industriel, nous avons les produits dont vous avez besoin. Stock permanent de 2000 tonnes pour une disponibilité immédiate.
...
**Tubes Canalisations**
- Tubes gaz soudés noirs
- Tubes gaz sans soudure
...
**UPN (Profilés en U)**
- De UPN 80 à UPN 300
- Pour structures et rails

**HEB, HEA, HEM**
- Sections lourdes disponibles sur commande

**Applications** : Structures porteuses, charpentes, planchers métalliques, ponts roulants, ossatures bâtiments.
...
**Cornières**
- À ailes égales : 20x20 à 200x200mm
- À ailes inégales : multiples dimensions
- Épaisseurs variées
...
### 🔹 Métal Déployé & Caillebotis

**Métal Déployé**
- Mailles losanges ou hexagonales
- Épaisseurs et formats variés
- Galvanisé ou brut

**Tôles Perforées**
- Perforations rondes ou carrées
- Sur mesure possible

**Applications** : Protection machines, garde-corps, clôtures, ventilation, filtration, décoration.
...
Nous disposons d'une gamme bien plus large que celle présentée ici. **Produit spécifique ? Besoin particulier ?**

<div class="cta-box">
  <h3>Contactez-nous pour tout besoin spécifique !</h3>
  <p>Notre équipe saura trouver le produit adapté à votre projet, même s'il n'apparaît pas dans cette liste.</p>
...
## Pourquoi Commander chez Métal Périgord ?

✓ **Stock immédiat** - 2000 tonnes disponibles
✓ **Qualité certifiée** - Produits aux normes européennes
